...
class CustomMetricsExporter:
    ...
    def collect(self):
        ...
        oldest_doc_date = models.Document.objects.aggregate(oldest=Min("created_at"))[
            "oldest"
        ]
        newest_doc_date = models.Document.objects.aggregate(newest=Max("created_at"))[
            "newest"
        ]
        ...
        metrics.append(
            GaugeMetricFamily(
                ...
                value=active_docs_last_30_days,
            )
        )
